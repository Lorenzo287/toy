...
var builtinDocs = map[string]builtinDoc{
	...
	"replicate": {Signature: "replicate ( n block -- list )", Description: "Execute a block n times and collect the top stack result of each execution into a list."},
	...
	"merge":    {Signature: "merge ( list1 list2 pred -- merged )", Description: "Merge two sorted lists using a predicate to determine order."},
