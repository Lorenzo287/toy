...
var builtinDocs = map[string]builtinDoc{
	...
	"infra":        {Signature: "infra ( list callable -- list )", Description: "Execute a callable using a list as a temporary stack and collect the resulting stack into a list."},
	...
	"cleave":       {Signature: "cleave ( x callable-list -- ... )", Description: "Apply several callables independently to the same value and leave all outputs on the stack."},
	"construct":    {Signature: "construct ( x callable-list -- list )", Description: "Apply several callables independently to the same value and collect their outputs into one list."},
	"times":        {Signature: "times ( n callable -- )", Description: "Execute a callable a fixed number of times."},
	"replicate":    {Signature: "replicate ( n callable -- list )", Description: "Execute a callable n times and collect exactly one result from each execution into a list."},
	"each":         {Signature: "each ( list|string callable -- )", Description: "Execute a callable for each item in a list or each byte in a string."},
	"map":          {Signature: "map ( list|string callable -- list|string )", Description: "Apply a callable to each item in a list or byte in a string and collect one result per item."},
	"fold":         {Signature: "fold ( init list|string callable -- acc )", Description: "Reduce a list or string from left to right by applying a callable to the accumulator and each item."},
	...
	"filter":       {Signature: "filter ( list|string callable -- list|string )", Description: "Keep sequence items for which a predicate callable returns true."},
	"some":         {Signature: "some ( list|string callable -- bool )", Description: "Check whether any sequence item satisfies a predicate callable."},
	"all":          {Signature: "all ( list|string callable -- bool )", Description: "Check whether every sequence item satisfies a predicate callable."},
	"split":        {Signature: "split ( list|string callable -- true false ) | ( str sep -- list )", Description: "Partition a list or string with a predicate callable, or split a string using a separator."},
	"splitmid":     {Signature: "splitmid ( list|string -- left right )", Description: "Split a list or string into left and right halves."},
	"merge":        {Signature: "merge ( seq seq callable -- seq )", Description: "Merge two sorted lists or strings of the same type. The predicate callable runs in a stack sandbox and must leave a boolean on top."},
	...
	"sequence?":    {Signature: "sequence? ( x -- bool )", Description: "Check whether the input can be iterated as a sequence: list or string."},
	"callable?":    {Signature: "callable? ( x -- bool )", Description: "Check whether the input can be executed now: a list or a symbol naming a defined word."},
	...
	"words":        {Signature: "words ( -- symbols )", Description: "Push a sorted list of dictionary word names as symbols."},
	...
	">map":         {Signature: ">map ( pairs -- map )", Description: "Build a map from a list of two-item key/value lists. Duplicate keys are an error."},
	">set":         {Signature: ">set ( list|string -- set )", Description: "Build a set from a list or string, collapsing duplicate items."},
	">deque":       {Signature: ">deque ( list|string -- deque )", Description: "Build a deque from a list or string, preserving front-to-back order."},
	">pqueue":      {Signature: ">pqueue ( pairs -- pqueue )", Description: "Build a priority queue from two-item [priority value] lists. Lower priorities are returned first."},
	...
	"keys":         {Signature: "keys ( map -- list )", Description: "Return map keys in insertion order."},
	"values":       {Signature: "values ( map -- list )", Description: "Return map values in insertion order."},
	"pairs":        {Signature: "pairs ( map -- list )", Description: "Return map entries as two-item key/value lists in insertion order."},
	"items":        {Signature: "items ( set -- list ) | ( deque -- list )", Description: "Return set items in insertion order or deque items from front to back."},
	...
	"pqueue-drain": {Signature: "pqueue-drain ( pqueue -- list )", Description: "Return all values in priority order without exposing heap storage order."},
	...
	"len":          {Signature: "len ( collection -- n )", Description: "Get the length of a list, string, map, set, deque, or priority queue."},
	...
	"reverse":      {Signature: "reverse ( list|string -- list|string )", Description: "Return a list or string with its items or bytes in reverse order."},
	...
	"empty?":       {Signature: "empty? ( collection -- bool )", Description: "Check whether a list, string, map, set, deque, or priority queue is empty."},
