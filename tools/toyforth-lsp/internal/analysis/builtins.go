...
var builtinDocs = map[string]builtinDoc{
	...
	"times":        {Signature: "times ( ... n callable -- ... )", Description: "Execute a callable a fixed number of times, threading the current stack through each run."},
	...
	"each":         {Signature: "each ( ... vector|list|string callable -- ... )", Description: "Execute a callable for each item in a vector or list, or each byte in a string, threading the current stack through each run."},
	...
	"split":        {Signature: "split ( vector|list|string callable -- true false ) | ( string sep -- vector )", Description: "Partition a vector, list, or string with a predicate callable, or split a string using a separator."},
	...
	"typeof":       {Signature: "typeof ( x -- string )", Description: "Push a string naming the input type."},
	...
	"string?":      {Signature: "string? ( x -- bool )", Description: "Check whether the input is a string."},
	...
	"intern":       {Signature: "intern ( string -- symbol )", Description: "Convert a string to a symbol."},
	"name":         {Signature: "name ( symbol -- string )", Description: "Convert a symbol to a string."},
	"words":        {Signature: "words ( -- vector )", Description: "Push a sorted vector of dictionary word names as symbols."},
	"see":          {Signature: "see ( 'name -- string )", Description: "Push a source-like representation of a word definition."},
	"load":         {Signature: "load ( path -- )", Description: "Load and execute a Toy source file in the current context."},
	"readf":        {Signature: "readf ( path -- string )", Description: "Read the entire content of a file into a string."},
	...
	"at":           {Signature: "at ( vector|string idx -- value|char )", Description: "Fetch a vector element or one-character string by index."},
	"set-at":       {Signature: "set-at ( vector idx value -- vector ) | ( string idx char -- string )", Description: "Return a collection with one element or character replaced."},
	">vector":      {Signature: ">vector ( vector|list|string -- vector )", Description: "Build a vector from a sequence, preserving order."},
	">list":        {Signature: ">list ( vector|list|string -- list )", Description: "Build a list from a sequence, preserving order."},
	...
	"contains?":    {Signature: "contains? ( vector|list|string item -- bool )", Description: "Check whether a sequence contains an item. String items are one-character strings."},
	"indexof":      {Signature: "indexof ( vector|list|string item -- idx|-1 )", Description: "Return the first index of an item in a sequence, or -1 when absent."},
	"unique":       {Signature: "unique ( vector|list|string -- vector|list|string )", Description: "Remove duplicate sequence items, preserving the first occurrence and input family."},
	"sort":         {Signature: "sort ( vector|list|string -- vector|list|string )", Description: "Sort numbers or strings in natural ascending order, preserving the input family."},
	...
	"front":        {Signature: "front ( deque -- item )", Description: "Consume a non-empty deque and return its front item. Use dup front to preserve the deque."},
	"back":         {Signature: "back ( deque -- item )", Description: "Consume a non-empty deque and return its back item. Use dup back to preserve the deque."},
	...
	"pqueue-peek":  {Signature: "pqueue-peek ( pqueue -- value )", Description: "Consume a priority queue and return the next value without exposing heap storage order. Use dup pqueue-peek to preserve the queue."},
	...
	"slice":        {Signature: "slice ( vector|string start end -- vector|string )", Description: "Return a sub-vector or substring from start up to, but not including, end."},
	"take":         {Signature: "take ( vector|list|string n -- vector|list|string )", Description: "Return the first n items or characters from a vector, list, or string."},
	"dropn":        {Signature: "dropn ( vector|list|string n -- vector|list|string )", Description: "Return a vector, list, or string with the first n items or characters removed."},
	...
	"cons":         {Signature: "cons ( x vector|list -- vector|list ) | ( char string -- string )", Description: "Add one item to the front of a vector or list, or one-byte string to the front of a string."},
	"append":       {Signature: "append ( vector|list x -- vector|list ) | ( string char -- string )", Description: "Add one item to the end of a vector or list, or one-byte string to the end of a string."},
	"concat":       {Signature: "concat ( vector vector -- vector ) | ( list list -- list ) | ( string string -- string )", Description: "Concatenate two vectors, two lists, or two strings."},
	...
	"join":         {Signature: "join ( vector|list sep -- string )", Description: "Join a vector or list of strings using a separator."},
	"trim":         {Signature: "trim ( string -- string )", Description: "Remove leading and trailing whitespace from a string."},
	"upper":        {Signature: "upper ( string -- string )", Description: "Convert a string to uppercase."},
	"lower":        {Signature: "lower ( string -- string )", Description: "Convert a string to lowercase."},
	...
	"pwd":          {Signature: "pwd ( -- string )", Description: "Push the current working directory."},
