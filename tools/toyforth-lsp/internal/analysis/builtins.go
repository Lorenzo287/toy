...
var builtinDocs = map[string]builtinDoc{
	...
	"items":     {Signature: "items ( set -- list )", Description: "Return set items in insertion order."},
	...
	"len":       {Signature: "len ( collection -- n )", Description: "Get the length of a list, string, map, or set."},
	...
	"empty?":    {Signature: "empty? ( collection -- bool )", Description: "Check whether a list, string, map, or set is empty."},
