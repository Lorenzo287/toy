...
var builtinDocs = map[string]builtinDoc{
	...
	"first":  {Signature: "first ( list -- x )", Description: "Get the first element of a list without consuming the list."},
	"rest":   {Signature: "rest ( list -- list )", Description: "Get all elements of a list except the first one, without consuming the original list."},
	"uncons": {Signature: "uncons ( list -- x list )", Description: "Destructure a list into its head and tail."},
	"cons":   {Signature: "cons ( x list -- list )", Description: "Add an element to the front of a list."},
	"concat": {Signature: "concat ( list1 list2 -- list )", Description: "Concatenate two lists."},
	"empty?": {Signature: "empty? ( list -- bool )", Description: "Check if a list is empty."},
